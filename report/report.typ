...
#[
  ...
  #set page(margin: 0pt)
  #image("preface.svg",height: 29cm,width: 21cm)
...
#Paragraph[
  ...
  推动社会变革的关键法宝。这一历史也表明, 调查只有做到深入群众、立足实际, 才能获得真实的信息, 提升对事物的认知。
]
#Paragraph[
...
#Paragraph[
  然而, 问卷调查方法面临严峻挑战。例如, 再复杂性社会科学中, 已有问卷调查设计难以满足研究需求, 
...
#Paragraph[
  总的来说, 本次问卷调查结果基本有效, 证明了通过互联网问卷的形式展开调查可以得出有效结论。
]
#Section("结论")
#Paragraph[
